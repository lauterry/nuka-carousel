...
var Carousel = (0, _createReactClass.default)({
  ...
  formatChildren: function formatChildren(children) {
    ...
    return _react.default.Children.map(children, function (child, index) {
      var classname = "slider-slide";
      var isLeftslide = _this3.state.currentSlide === index + 1 || _this3.state.currentSlide === 0 && index === children.length - 1;
      var isRightSlide = _this3.state.currentSlide === index - 1 || _this3.state.currentSlide === children.length - 1 && index === 0;

      if (_this3.state.currentSlide === index) {
        classname = "slider-slide slider-slide-active";
      } else if (_this3.props.slidesToShow === 3 && isLeftslide) {
        classname = "slider-slide slider-slide-left";
      } else if (_this3.props.slidesToShow === 3 && isRightSlide) {
